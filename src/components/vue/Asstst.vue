...
<template>
  <div class="flex flex-col gap-4">
    ...
    <div class="flex flex-wrap justify-center items-center gap-6">
      <a v-for="(file, index) in files" :key="file.key" :href="`https://files.ckpavv.workers.dev/${file.key}`" target="_blank" class="group w-full md:w-52 md:h-52 p-2 hover:shadow-md cursor-pointer flex justify-center items-center !bg-gray-100 rounded relative">
