...
# 整体开发体验
使用 `Tauri 2.0` 开发的应用, 如果是原生功能相关较少,大部分基于 Web 开发 整体体验还行, 如果设计到原生功能, 则需要使用 Tauri 提供的插件 https://tauri.app/zh-cn/plugin/ , 否则的话还是需要通过安卓 或者 ios 来进行原生功能的开发. 如果不熟悉的话还是比较困难, 遇到一些问题, `Tauri 2.0` 的文档也不是很详细, 相关解决方案也比较少, 所以还是需要自己去探索.
